...
const NewPropertyType = () => {
  ...
  const handleClick = async (e) => {
    ...
    try {
      ...
      await axios.post("/api/propertyTypes/", newPropertyType,{ withCredentials: true });
    } catch (error) {
      console.log(error);
    }
  ...
  return (
    <>
      ...
      <InfoModal setShowModal={setShowModalInfo} showModal={showModalInfo} info="Se ha creado de forma exitosa" />
